...
import com.sebastian.dev.projecttaskmanagement.controller.dto.UpdateProjectDTO;
...
public class ProjectController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('PROJECT_USER', 'ADMIN', 'PROJECT_MANAGER')")
    ...
    public ResponseEntity<ProjectDTO> findProjectByName(@PathVariable String projectName) {
        ProjectDTO responseDTO = DTOMapper.toProjectDTO(projectService.findProjectByName(projectName));
        return ResponseEntity.ok(responseDTO);
    }
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'PROJECT_MANAGER')")
    public ResponseEntity<ProjectDTO> updateProject(@PathVariable UUID id, @Valid @RequestBody UpdateProjectDTO project) {
        ProjectDTO responseDTO = DTOMapper.toProjectDTO(projectService.updateProject(id, project.name()));
